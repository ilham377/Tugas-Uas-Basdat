...
<div class="col-md-12 p-5 pt-2">
   <h3><i class="fas fa-money-bill-wave mr-2"></i>Angkatan</h3><hr>
...
<table class="table table-bordered">
  <thead class="thead-dark">
    <tr>
      <th scope="col">No</th>
      <th scope="col">Id Angkatan</th>
      <th scope="col">NIM</th>
      <th scope="col">Jurusan</th>
      <th scope="col">Angkatan Tahun</th>
    ...
    <tr>
      ...
      <td>{{ $val->tahun}}</td>
        ...
        <td><a href="#" class="fas bg-warning p-2 text-white rounded edit-modal-click" data-id="">Edit</a></td>
         <td><a href="javascript:;" data-toggle="modal" onclick="deleteData('{{$val->Id_angkatan}}')" data-target="#DeleteModal" class="fas bg-danger p-2 text-white rounded">Delete</td>
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <div class="modal-body">
            <form action="/akt/store" method="post">
              @csrf
              <div class="form-group">
                  <label>Id Angkatan</label>
                    <input type="text" name="id_akt" class="form-control">      
                  </div>
                <div class="form-group">
                  <label>NIM</label>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <div class="modal-body">
            <form action="/akt/update" method="post">
              @csrf
            
                <div class="form-group">
                  <label>Id Angkatan</label>
                    <input type="text" name="eid_akt" id="edit-idakt" class="form-control" readonly>      
                  </div>
                <div class="form-group">
                  <label>NIM</label>
                    <input type="text" name="enim" id="edit-nim" class="form-control">      
                  </div>
                <div class="form-group col-md-5">
                  <label>Jurusan</label>
                  ...
                  <div class="form-group">
                  <label>Tahun</label>
                    <input type="year" name="etahun" id="edit-tahun"class="form-control">      
                  </div>
...
<script type="text/javascript">
  $(document).on("click", ".edit-modal-click", function () {
    ...
    var akt = rowCells.eq(1).text();
    var nim = rowCells.eq(2).text();
    var jrs = rowCells.eq(3).text();
    var tahun = rowCells.eq(4).text();
     $("#edit-id").val(id);
     $("#edit-idakt").val(akt);
     $("#edit-nim").val(nim);
     $("#edit-idjrs").val(jrs);  
